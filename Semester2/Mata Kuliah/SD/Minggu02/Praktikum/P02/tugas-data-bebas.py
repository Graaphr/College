...
pygame.display.set_caption("DATA GAME STUDIO")
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if buttonUbah.collidepoint(event.pos):
                if baris_text.isdigit() and kolom_text.isdigit() and nilai_text:
                    b = int(baris_text)
                    k = int(kolom_text)
                    n = nilai_text
    ...
    # VIEW
    title = title_font.render("DATA GAME STUDIO", True, BLACK)
    ...
    screen.blit(font.render("Data Baru",True,BLACK),(60,250))
